    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <div class="btnViewCart btn-outline-dark">
          <a href="<%=request.getContextPath()%>/viewcart?idProduct=${product.id}&ship=0" class="ViewCartLink"><i class="bi-cart-fill me-1"></i>
            Cart
            </a>
        </div>
    </div>
...
<section class="py-5">
  <div class="container px-4 px-lg-5 my-5">
    <div class="row gx-4 gx-lg-5 align-items-center">
      <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="${product.urlImage}" alt="..." /></div>
      <div class="col-md-6">
        ...
        <div class="d-flex">
          <button class="btn btn-outline-dark flex-shrink-0" type="button"><a href="<%=request.getContextPath()%>/bill?idProduct=${product.id}" class="nav-link">
  ...
  <div class="container px-4 px-lg-5 mt-5">
    ...
    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
        <c:forEach items="${listRelatedProduct}" var="relatedProduct">
            <div class="col mb-5">
                <a class="card h-100" href="<%=request.getContextPath()%>/ViewProduct?idproduct=${relatedProduct.id}">
                    <!-- Product image-->
                    <img class="card-img-top" src="${relatedProduct.urlImage}" alt="..." />
                    <!-- Product details-->
