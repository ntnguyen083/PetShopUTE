...
<section class="w3l-services py-5">
  <div class="container py-md-5 py-4">
    <div class="position-relative">
      <h3 class="title-style text-center mb-sm-5 mb-4">Tại sao nên chọn chúng tôi</h3>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 grids-feature">
        <div class="area-box">
          ...
          <h4><a href="about.jsp" class="title-head">Chuyên gia dinh dưỡng</a></h4>
          <p class="">Cung cấp các thành phần dinh dưỡng có ích cho thú cưng.</p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-5">
        <div class="area-box">
          <i class="fas fa-bone color-2"></i>
          <h4><a href="about.jsp" class="title-head">Chất lượng và an toàn</a></h4>
          <p class="">Các sản phẩm và dịch vụ luôn được đảm bảo tốt nhất.</p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-5">
        <div class="area-box">
          ...
          <p class="">Kiểm tra và sử dụng các thực phẩm đúng cách cho thứ cưng</p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 grids-feature mt-5">
        <div class="area-box">
          ...
          <p class="">Nếu bạn đang muốn tìm thú cưng hãy đến với chúng tôi.</p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 grids-feature mt-5">
        <div class="area-box">
      ...
      <div class="col-lg-4 col-md-6 grids-feature mt-5">
        <div class="area-box">
          ...
          <p class="">Với nhiều năm kinh nghiệm trong nghề, chúng tôi sẽ đào tạo cho thú cưng của bạn các kĩ năng đỉnh cao.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-6 ps-lg-5 mb-lg-0 mb-5 order-lg-last order-first">
        ...
        <div class="mt-4">
          <ul class="service-list">
            <li class="service-link"><a href="#url"><i class="fas fa-check-circle"></i>Được chứng nhận</a></li>
            <li class="service-link"><a href="#url"><i class="fas fa-check-circle"></i>20 năm kinh nghiệm</a></li>
            <li class="service-link"><a href="#url"><i class="fas fa-check-circle"></i>Tình yêu dành cho thú cưng</a>
            </li>
          </ul>
        </div>
...
<section class="w3l-pricing pt-5">
  <div class="container py-md-5 py-4">
    <div class="position-relative">
      <h3 class="title-style text-center mb-sm-5 mb-4">Các dịch vụ tốt nhất</h3>
      <div class="title-paw-style">
        <i class="fas fa-paw"></i>
        <i class="fas fa-paw paw-2"></i>
        <i class="fas fa-paw paw-3"></i>
