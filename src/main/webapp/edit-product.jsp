            ...
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                ...
                <div class="row tm-edit-product-row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <form action="<%=request.getContextPath()%>/HandleProductAdmin?action=editCategory&idcategory=${idCategory}"
                            ...
                            <div class="col-12" style="padding: 0">
                                <button type="submit" class="btn btn-primary btn-block text-uppercase">Update Category
                                    Now
                                </button>
                            </div>
                        </form>
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                ...
                <div class="row tm-edit-product-row" style="display: block">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <form action="<%=request.getContextPath()%>/HandleProductAdmin?action=editProduct&idproduct=${idProduct}" class="tm-edit-product-form" method="post">
                                ...
                                <div style="flex: 1;padding-right: 15px">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                                ...
                                                name="category"
                                        >
                                            <option selected value="${categoryname.getIdCategory()}">${categoryname.getCategory()}</option>
                                ...
                                <div style="flex: 1">
                                    <div class="col-xl-12 col-lg-12 col-md-12 mx-auto mb-4" style="padding-right: 0">
                                        ...
                                        <div class="custom-file mt-3 mb-3">
                                            <input id="fileInput" name="fileInput" value="${urlImage}" type="file" style="display: none" />
                                            <span>${urlImage}</span>
                                            <input
                                                    type="button"
